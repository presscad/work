...
class CYonghuCardPage: public CWindowWnd, public INotifyUI
{
public:
	CYonghuCardPage(void);
	~CYonghuCardPage(void);
	...
	void ShowhideTFj()
	{
		CButtonUI* pTingji = static_cast<CButtonUI*>(m_pm.FindControl(_T("YHK_cardfujibtn")));
		CButtonUI* pFuji = static_cast<CButtonUI*>(m_pm.FindControl(_T("YHK_cardfujibtn")));
		if (g_strUserType == "2")
		{
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		CControlUI* pRoot = builder.Create(_T("用户卡.xml"), (UINT)0,  &cb, &m_pm);
...
private:
	...
	public:
void InitInfo(string strType, string strKehu,string strkehuid,int nCmdType);
public:
