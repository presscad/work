...
class CJingliKehuPage:public CWindowWnd, public INotifyUI
{
public:
	CJingliKehuPage(void);
	~CJingliKehuPage(void);
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		CControlUI* pRoot = builder.Create(_T("经理客户.xml"), (UINT)0,  &cb, &m_pm);
	...
	LRESULT HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
	{
		...
		case WM_JLKH_LIST_MSG:lRes = OnJLKHmsg(uMsg, wParam, lParam, bHandled); break;
		case WM_JL_QUERY_MSG:lRes = OnJLQuerymsg(uMsg, wParam, lParam, bHandled); break;
		default:
			bHandled = FALSE;
		}
...
private:
	...
	LRESULT  OnJLKHmsg(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled);
	LRESULT  OnJLQuerymsg(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled);
	LRESULT  OnUpdatestatemsg(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled);
	public:
void InitInfo(string strjingNmae);
public:
