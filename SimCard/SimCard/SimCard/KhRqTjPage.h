...
class CKhRqTjPage:public CWindowWnd, public INotifyUI
{
public:
	CKhRqTjPage(void);
	~CKhRqTjPage(void);
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		CControlUI* pRoot = builder.Create(_T("客户日期统计.xml"), (UINT)0,  &cb, &m_pm);
	...
	LRESULT HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
	{
		...
		case WM_KH_RQTJ_MSG:lRes = OnKhRqtjmsg(uMsg, wParam, lParam, bHandled); break;
...
private:
	...
	LRESULT  OnKhRqtjmsg(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled);
	
	public:
void InitInfo(string strku,string strkuid);
public:
